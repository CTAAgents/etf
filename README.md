...
| 技能 | 版本 | 说明 | 核心指标 |
|:--|:--:|:--|:--|
| [a-share-etf-momentum](./a-share-etf-momentum/) | 1.9.0 | A股行业ETF双动量轮动策略 — 绝对动量择时+相对动量轮动+估值分位刹车。通过沪深300ETF判断市场趋势，多头轮动持有最强行业ETF，熊市切换货币ETF。支持完整回测与实... | 年化44.30%，夏普1.275 |
| [etf-trend-signal](./etf-trend-signal/) | 2.4.0 | 行业ETF通道突破策略 — 唐奇安通道+布林带+成交量评分，31行业轮动 | 31行业扫描，周频调仓，完整执行管道 |
